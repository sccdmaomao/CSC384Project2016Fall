...
if __name__ == "__main__":
    ...
    final = se.search(s0, waterjugs_goal_fn, waterjugs_h_sum_function)
    if final: final.print_path()
    print("===================================================")
    print("")

    print("=========Test 2. Astar with h_max heuristic========")
    final = se.search(s0, waterjugs_goal_fn, waterjugs_h_max_function)
    if final: final.print_path()        
    print("===================================================")
    print("")
    ...
    final = se.search(s0, waterjugs_goal_fn)
    if final: final.print_path()    
    print("===================================================")
    print("")
